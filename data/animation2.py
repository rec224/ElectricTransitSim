...
for filter in range(0, 51, 1):
  ...
  plt.title("Energy (kWh) vs distance (miles) driving for at least " + str(filter) + " percent of the hour")
  # leg = plt.legend(loc ="upper right");
  filename = "animation_chartsv3/chart" + str(filter)
#   plt.xlim(0,150)
#   plt.ylim(0,65)
